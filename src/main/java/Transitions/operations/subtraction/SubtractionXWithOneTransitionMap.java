...
public class SubtractionXWithOneTransitionMap implements TransitionMap {

    private final  Map<Symbol, Transition> map;

    public SubtractionXWithOneTransitionMap(){
       map = new HashMap<>();
       ...
       map.put(Symbol.CARRY, new Transition(State.Q_SUBTRACTION_X_WITH_ONE_AND_CARRY, Symbol.X, Direction.RIGHT));
