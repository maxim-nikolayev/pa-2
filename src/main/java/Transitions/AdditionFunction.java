...
import Transitions.operations.addition.*;
...
public class AdditionFunction implements TransitionFunction {
    ...
    public Map<State, Map<Symbol, Transition>> initializeTransitionFunction() {
        transitionFunction.put(State.START_ADDITION_OPERATION, new StartAdditionOperationTransitionMap().getTransitionMap());
        transitionFunction.put(State.Q_ADDITION_Y, new AdditionYTransitionMap().getTransitionMap());
        transitionFunction.put(State.Q_ADDITION_X_WITH_ZERO, new AdditionXWithZeroTransitionMap().getTransitionMap());
        transitionFunction.put(State.Q_ADDITION_X_WITH_ZERO_AND_CARRY, new AdditionXWithZeroAndCarryTransitionMap().getTransitionMap());
        transitionFunction.put(State.Q_ADDITION_X_WITH_ONE, new AdditionXWithOneTransitionMap().getTransitionMap());
        transitionFunction.put(State.Q_ADDITION_X_WITH_ONE_AND_CARRY, new AdditionXWithOneAndCarryTransitionMap().getTransitionMap());
